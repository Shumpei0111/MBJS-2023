...
export const MarqueeEnjoy: React.FC<Props> = ({
  ...
  const Item: React.FC<Props> = ({ isRight }) => (
    <span
      className={`text-black uppercase text-141 whitespace-nowrap items-center flex pr-6 ${
  ...
  return (
    <div
      className={`w-screen h-160 my-0 mx-[calc(50%_-_50vw)] overflow-hidden mt-32 flex items-center bg-primary ${
